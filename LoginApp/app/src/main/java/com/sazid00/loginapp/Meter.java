...
public class Meter extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == R.id.sign)
        {
            ...
            Intent intent = new Intent(Meter.this,Login.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        male.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Meter.this, "Male Selected", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        female.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Meter.this, "Female Selected", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bmi_cal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Float result = kg_calc/(height_calc*height_calc);
